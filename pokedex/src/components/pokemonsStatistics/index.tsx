...
const PokemonsStatistics: FunctionComponent<PokemonStatsProps> = ({
  pokemon,
}) => {
  return (
    <StylePokemonsStatistics>
      ...
      <StyleCenterDiv>
        <BlueDiv>
          ...
          <p>
            {(pokemon as Pokemon).additionalData?.height ||
              (pokemon as Pokemon2).height}
          </p>
          <WhiteText>Weight</WhiteText>
          <p>
            {(pokemon as Pokemon).additionalData?.weight ||
              (pokemon as Pokemon2).weight}
          </p>
